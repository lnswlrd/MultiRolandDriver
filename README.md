...
Open-source CoreMIDI driver plugin for macOS that replaces Roland's broken legacy drivers. Supports 36 Roland/Edirol USB devices as a universal binary (arm64 + x86_64).
